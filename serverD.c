...
//    printf("connected to server \r\n");
   ...
   // printf("TCP prot number %d ",remote_addr.sin_port);
    ...
    printf("The Server D finishe sending its neighbor information to the Client with TCP port number: %d and IP address: %s \n", TCP, inet_ntop(hptr->h_addrtype, *pptr, str, sizeof(str)));
    
    printf("For this connection with Client, the Server D has TCP port number: %d and IP address: %s \n", remote_addr.sin_port,inet_ntop(hptr->h_addrtype, *pptr, str, sizeof(str)));
